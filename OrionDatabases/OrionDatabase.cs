...
namespace OrionDatabases
{
    ...
    public abstract class OrionDatabase : OrionErrorManager, IDisposable
    {
        #region Fields
        ...
        ///// </summary>
        ///// <remarks>If value is <i>true</i>, opened connection to the database is not closed after each SQL request. So the proper way to close it is to call the <see cref="Disconnect" /> method. If value is <i>false</i>, connection is automatically closed after each method call which execute a SQL request. It is the default <see cref="XDatabase" /> behavior.
        ///// <br />Any opened connection is automatically closed before disposing <see cref="XDatabase" /> object.</remarks>
        ///// <value>Type : <see cref="System.Boolean"/>
        ...
        //    get
        //    {
        //        return this.m_bPersistentConnection;
        //    }
        //    set
        //    {
        //        if (value != this.m_bPersistentConnection)
        //        {
        //            this.m_bPersistentConnection = value;
        //            this.OnPropertyChanged("PersistentConnection");
        //        }
        //    }
        //}
        ...
        public void Disconnect()
        {
            ...
            if (this.Connection != null)
            {
                ...
                //            if (this.Connection.State != ConnectionState.Closed && iAttemptCounter == 3) throw new XException("Error while disconnecting from database (3 attempts)", ex);
                //        }
                //    }
            }
            else
